...
public class RouteResolutionTests
{
    ...
    {
        var route1 = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p1"), LogicalModelId.From("client-model"), ModelRouteId.From("r1"), "provider-model", true, ModelCapability.None) };
        var route2 = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p2"), LogicalModelId.From("client-model"), ModelRouteId.From("r2"), "provider-model", true, ModelCapability.None) };
    ...
    {
        var enabled = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p"), LogicalModelId.From("client-model"), ModelRouteId.From("r1"), "provider-model", true, ModelCapability.None) };
        var disabled = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = false, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p"), LogicalModelId.From("client-model"), ModelRouteId.From("r2"), "provider-model", false, ModelCapability.None) };
    ...
    {
        var disabled = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = false, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p"), LogicalModelId.From("client-model"), ModelRouteId.From("r1"), "provider-model", false, ModelCapability.None) };
    ...
    {
        var eligible = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p1"), LogicalModelId.From("client-model"), ModelRouteId.From("r1"), "provider-model", true, ModelCapability.None) };
        var ineligible = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = false, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p2"), LogicalModelId.From("client-model"), ModelRouteId.From("r2"), "provider-model", false, ModelCapability.None) };
    ...
    {
        var r1 = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p1"), LogicalModelId.From("client-model"), ModelRouteId.From("r1"), "provider-model", true, ModelCapability.None) };
        var r2 = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p2"), LogicalModelId.From("client-model"), ModelRouteId.From("r2"), "provider-model", true, ModelCapability.None) };
    ...
    {
var preferred = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, QualityTier = DeclaredQualityTier.Preferred, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p1"), LogicalModelId.From("client-model"), ModelRouteId.From("r-pref"), "provider-model", true, ModelCapability.None, DeclaredQualityTier.Preferred) };
        var acceptable = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, QualityTier = DeclaredQualityTier.Acceptable, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p2"), LogicalModelId.From("client-model"), ModelRouteId.From("r-acc"), "provider-model", true, ModelCapability.None, DeclaredQualityTier.Acceptable) };
    ...
    {
        var acceptable = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, QualityTier = DeclaredQualityTier.Acceptable, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p"), LogicalModelId.From("client-model"), ModelRouteId.From("r-acc"), "provider-model", true, ModelCapability.None, DeclaredQualityTier.Acceptable) };
        var fallback = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, QualityTier = DeclaredQualityTier.Fallback, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p"), LogicalModelId.From("client-model"), ModelRouteId.From("r-fb"), "provider-model", true, ModelCapability.None, DeclaredQualityTier.Fallback) };
    ...
    {
        var preferredDisabled = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = false, QualityTier = DeclaredQualityTier.Preferred, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p1"), LogicalModelId.From("client-model"), ModelRouteId.From("r-pref"), "provider-model", false, ModelCapability.None, DeclaredQualityTier.Preferred) };
    ...
    {
var pref1 = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, QualityTier = DeclaredQualityTier.Preferred, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p1"), LogicalModelId.From("client-model"), ModelRouteId.From("r-pref1"), "provider-model", true, ModelCapability.None, DeclaredQualityTier.Preferred) };
        var pref2 = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, QualityTier = DeclaredQualityTier.Preferred, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p1"), LogicalModelId.From("client-model"), ModelRouteId.From("r-pref2"), "provider-model", true, ModelCapability.None, DeclaredQualityTier.Preferred) };
    ...
    {
var acc1 = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, QualityTier = DeclaredQualityTier.Acceptable, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p1"), LogicalModelId.From("client-model"), ModelRouteId.From("r-acc1"), "provider-model", true, ModelCapability.None, DeclaredQualityTier.Acceptable) };
        var acc2 = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, QualityTier = DeclaredQualityTier.Acceptable, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p1"), LogicalModelId.From("client-model"), ModelRouteId.From("r-acc2"), "provider-model", true, ModelCapability.None, DeclaredQualityTier.Acceptable) };
    ...
    {
        var route = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = true, QualityTier = DeclaredQualityTier.Preferred, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p"), LogicalModelId.From("client-model"), ModelRouteId.From("r1"), "provider-model", true, ModelCapability.None, DeclaredQualityTier.Preferred) };
    ...
    {
        var disabled = new ConfiguredRoute { RequestedModelAlias = "client-model", Enabled = false, QualityTier = DeclaredQualityTier.Preferred, ModelRoute = ModelRoute.FromIdsWithOptions(ProviderId.From("p"), LogicalModelId.From("client-model"), ModelRouteId.From("r1"), "provider-model", false, ModelCapability.None, DeclaredQualityTier.Preferred) };
        var config = new RoutingConfiguration { Routes = new List<ConfiguredRoute> { disabled } };
        var resolver = new ConfiguredRouteResolver(Options.Create(config), new HardRouteEligibilityEvaluator(), new RouteHealthRanker(new InMemoryRouteHealthStateProvider()), new InMemoryRouteCapacityCoordinator());
        var result = await resolver.ResolveAsync(new CanonicalChatRequest { RequestedModel = "client-model", Messages = new List<CanonicalChatMessage> { new() { Role = "user", Content = "hi" } } }, CancellationToken.None);
        Assert.False(result.IsSuccess);
