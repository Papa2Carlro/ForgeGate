...
/// <summary>
/// HTTP smoke tests for successful chat completion paths through the server.
/// </summary>
public class ChatCompletionsSuccessSmokeTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;

    public ChatCompletionsSuccessSmokeTests(WebApplicationFactory<Program> factory)
    {
        _factory = factory;
    }
